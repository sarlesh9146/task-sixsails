...
class sprintTask{
    ...
    public function displaySprintDetails($devloper_with_priority){
    ...
    public function getSprintDuration(){
        $priority_row=$this->getPriorityList();
    ...
    return $this->displaySprintDetails($devloper_with_priority);
    }
}

$sprint_data=new sprintTask;
$data=$sprint_data->getSprintDuration();
